...
def main():
    ...
    data, img, img2lidar, intrinsic, timestamp, ego_pose, ego_pose_inv, \
        prev_exists, mem_embedding, mem_timestamp, mem_egopose, mem_ref_point, mem_velo = nus_data.load_data(cfg.model)
    # print(data)
