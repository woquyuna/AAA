...
class StreamPETRHead(AnchorFreeHead):
    ...
    def pre_update_memory(self, data):
        ...
        if self.memory_embedding is None:
            ...
            print("self.memory_egopose:", self.memory_egopose.shape)
    ...
    def temporal_alignment(self, query_pos, tgt, reference_points):
        ...
        if self.with_ego_pos:
            ...
            print("tgt:", tgt.shape)
            # print(tgt)
            # tgt.cpu().detach().numpy().tofile('/mnt/data/userdata/hjj/streampetr_data/tgt_1x300x256.bin')
    ...
    def forward(self, memory_center, img_metas, topk_indexes=None,  **data):
        ...
        print("pre memory_egopose:", self.memory_egopose.shape)
        ...
        print("post memory_egopose:", self.memory_egopose.shape)
        # print(all_cls_scores)
        # print(all_bbox_preds)
        # all_cls_scores.cpu().detach().numpy().tofile('/mnt/data/userdata/hjj/streampetr_data/all_cls_scores_debug.bin')
        # all_bbox_preds.cpu().detach().numpy().tofile('/mnt/data/userdata/hjj/streampetr_data/all_bbox_preds_debug.bin')
        # import sys
        # sys.exit(0)
    ...
    def position_embeding_pth(self, data, memory_centers, topk_indexes, img_metas):
        ...
        # print(coords)
        # coords.cpu().detach().numpy().tofile('/mnt/data/userdata/hjj/streampetr_data/coords_1x4224x64x4x1.bin')
        ...
        # img2lidars.cpu().detach().numpy().tofile('/mnt/data/userdata/hjj/streampetr_data/img2lidars_1x4224x64x4x1.bin')
        coords3d = torch.matmul(img2lidars, coords).squeeze(-1)[..., :3]
